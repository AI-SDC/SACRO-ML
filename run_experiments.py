                ...
                for scenario in scenarios:
                    ...
                    if scenario.lower() == "worst_case" or scenario == "WorstCase":
                        ...
                        try:
                            ...
                            print(
                                f"Directory outputs_worstcase_{target_model_id} already removed"
                            )
                    elif scenario.lower() in ("lira", "lira-online-carlini", "lira-offline-carlini"):
                        ...
                        with open(
                            "lira_config_" + str(target_model_id) + ".json",
                            "w",
                            encoding="utf-8",
                        ) as f:
                            f.write(json.dumps(config))

                        mode = "offline"  # original CDF
                        if scenario.lower() == "lira-online-carlini":
                            mode = "online-carlini"
                        elif scenario.lower() == "lira-offline-carlini":
                        ...
                        attack_obj = LIRAAttack(
                            ...
                            attack_config_json_file_name="lira_config_"
                            + str(target_model_id)
                            + ".json",
                        )

...
from safemodel.classifiers.safedecisiontreeclassifier import decision_trees_are_equal
from safemodel.classifiers.safedecisiontreeclassifier import get_tree_k_anonymity
def get_data():
...
def test_decisiontree_hacked_postfit():
    ...
    part3 = reporting.get_reporting_string(name="internal_attribute_differs",attr="max_depth")
    part4=  reporting.get_reporting_string(name="internal_attribute_differs",attr="value")

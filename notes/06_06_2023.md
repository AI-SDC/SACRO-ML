...
1. Version 1.0.5 (5th of June 2023 - Monday) - Done 
   - Issue 126 (around JSON output documentation) and configuration file documentation - Implemented as readme.md in SACRO-ML repo. Thanks Richard Preen for bringing it into sphinx documentation of AI-SDC
...
4. CC to respond who in HIC will point of contact?
5. AOB

...
1. Version 1.0.5 (5th of June 2023 - Monday) - Done 
   - Issue 126 (around JSON output documentation) and configuration file documentation - Implemented as readme.md in SACRO-ML repo. Thanks Richard Preen for brining it into sphinx documentation
